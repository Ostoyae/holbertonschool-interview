...
**Table Of Context**
- [0. Slide line](#0-Slide-line)

## Tasks


### 0. Slide line
File: **[0-slide_line.c, slide_line.h](0-slide_line.c, slide_line.h)**
 ...
 *
martin@array: Pointer to the array of integer to be printed
martin@size: Number of elements in @array
 */
